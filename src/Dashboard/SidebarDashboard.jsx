...
const SidebarDashboard = ({ role, handleActiveTab, isActiveTab,setSidebarOpen,sidebarOpen }) => {
    const currentPath = window.location.pathname;
    console.log("sidebarOpen value in sidebar",sidebarOpen);
    ...
    return (
        <>
            ...
            <aside
                ...
                } ${sidebarOpen ?'absolute z-20' : 'relative'} inset-y-0 left-0  w-64 bg-gradient-to-br from-indigo-800 to-purple-900 text-white p-6 shadow-xl transform transition-transform duration-300 ease-in-out  md:translate-x-0  md:flex-col md:h-full`}
            >
