    ...
    const getLinks = () => {
        switch (role) {
            ...
            case "officer":
                return [
                    {
                        name: "Criminals Records",
                        //  path: "/officer" ,
                        tab: "criminalsrecords",
                    },
                    {
                        name: "Profile",
                        //  path: "/profile" ,
                    ...
                    {getLinks().map((link, index) => {
                        ...
                        return (
                            <Link
                                ...
                                onClick={() => {
                                    window.innerWidth < 768 && setIsOpen(false); // Close mobile menu
                                    handleActiveTab(link.tab); // Pass tab name
                                    // setIsActive(isActiveTab === link.tab);
