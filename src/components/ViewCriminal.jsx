            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{age || "N/A"}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-500">Crime Type</label>
                  <p className="font-semibold text-gray-800">{crimeType || "N/A"}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-500">Address</label>
                  <p className="font-semibold text-gray-800">{address || "N/A"}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-500">Case Number</label>
                  <p className="font-semibold text-gray-800">{caseNo}</p>
                </div>
                <div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            <div className="h-96 w-full rounded-lg overflow-hidden shadow-inner border border-gray-300 bg-gray-200">
              {coordinates.length >= 2 ? (
                <MapComponent selectedCriminal={criminal} criminals={[criminal]} />
              ) : (
