...
const AddPoliceStation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post(endpoint.station.create, formData);
      setSubmitSuccess("Police station added successfully!", response.data);
      setSubmitError("");
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-blue-700 via-indigo-800 to-purple-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold">Add Police Station</h1>
          <p className="mt-2 text-sm md:text-base">Register a new police station in Barrackpore</p>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50 min-h-screen">
        <div className="container mx-auto px-4">
          <div className="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-200">
            <h2 className="text-2xl font-bold mb-6 text-gray-800">Register Station</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${
                    errors.stationName ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-blue-500"
                  }`}
                />
                {errors.stationName && (
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${
                    errors.contactNumber ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-blue-500"
                  }`}
                />
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 ${
                    errors.coordinates ? "border-red-500 focus:ring-red-400" : "border-gray-300 focus:ring-blue-500"
                  }`}
                />
              </div>
            ...
            <div className="mb-4">
              ...
              <MapPicker coordinates={formData.location.coordinates} setCoordinates={(coords) => {
                setFormData((prev) => ({
                  ...prev,
                  location: {
                    ...prev.location,
