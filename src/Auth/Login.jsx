...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post(endpoint.auth.login, formData); // Make sure this matches your endpoint
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-blue-700 via-indigo-800 to-purple-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-2 text-sm md:text-base">Welcome back to Barrackpore Police Commissionerate</p>
        </div>
      </section>
  ...
  >
    {showPassword ? (
      ...
      // Eye Open Icon
      <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 left-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
