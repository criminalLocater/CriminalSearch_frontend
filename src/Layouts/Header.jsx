            ...
            <div className="flex items-center">
              ...
              <nav className="hidden md:block ml-10">
                <div className="flex space-x-10">
                  <a href="/" className="text-sm font-medium text-gray-900 hover:text-indigo-700">
                    Home
                  </a>
                  <a href="/services" className="text-sm font-medium text-gray-900 hover:text-indigo-700">
                    Services
                  </a>
                  <a href="/wanted" className="text-sm font-medium text-gray-900 hover:text-indigo-700">
                    Wanted List
                  </a>
                  <a href="/contact" className="text-sm font-medium text-gray-900 hover:text-indigo-700">
                    Contact
                  </a>
                </div>
              </nav>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <a href="/service" className="block px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100">
                Services
              </a>
    ...
    <div className="relative ml-6">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
          <div className="py-1">
            <p className="px-4 py-2 text-sm text-gray-700 border-b truncate">{user.fullName}</p>
            <a
              href="/profile"
            ...
            <a
              href={user.role === "admin" ? "/admin" : user.role === "sic"
      ? "/sic"
      : "/user"}
